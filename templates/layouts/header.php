...
//TẠM THỜI TẮT TÍNH NĂNG ĐĂNG NHẬP, NHỚ BẬT LẠI!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// if (!$isLogin) {
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo _HOST_URL_TEMPLATES; ?>/assets/css/admin.css" />
    <link rel="stylesheet" href="<?php echo _HOST_URL_TEMPLATES; ?>/assets/css/custom?ver<?php echo rand(); ?> .css" />
    <link rel="stylesheet" href="<?php echo _HOST_URL_TEMPLATES; ?>/assets/css/profile?ver<?php echo rand(); ?> .css" />
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img src=" <?php _HOST_URL;  ?><?php echo isset($avatarUser) ? $avatarUser : false; ?>"
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-header text-bg-primary">
                                <img src=" <?php _HOST_URL; ?><?php echo _HOST_URL . isset($avatarUser) ? $avatarUser : false; ?>"
